...
public class MetroHomePage {
    ...
    private final By routeStationFromTo = By.className("route-details-block__station-list-item");
    ...
    public void chooseCity(String cityName){
        ...
        //driver.findElement(By.className("select_metro__drop")).click();
    ...
    public void setStationFrom(String fromStation){
        // введи название станции в поле ввода, а затем с помощью клавиш «Вниз» и Enter выбери его в выпадающем списке саджеста
        driver.findElement(fieldFrom).sendKeys(fromStation, Keys.DOWN, Keys.ENTER);
    }

    // метод ввода названия станции в поле «Куда»
    public void setStationTo(String toStation){
        // введи название станции в поле ввода, а затем с помощью клавиш «Вниз» и Enter выбери его в выпадающем списке саджеста
        driver.findElement(fieldTo).sendKeys(toStation, Keys.DOWN, Keys.ENTER);
    ...
    public String getRouteStationTo() {
        ...
        int stationListLastItem = driver.findElements(By.className("route-details-block__station-list-item")).size() - 1;
        return driver.findElements(routeStationFromTo).get(stationListLastItem).getText();
    }
